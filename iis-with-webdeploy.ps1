...
Invoke-WebRequest -UseBasicParsing -Uri "https://csged50dd698631x4a14xa7d.blob.core.windows.net/scripts/ntmssampleapp.zip" -OutFile $msiFile
Expand-Archive $msiFile C:\inetpub\
#Done